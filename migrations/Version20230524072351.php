 ...
 */
final class Version20230524072351 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season CHANGE program program_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season CHANGE program_id program INT NOT NULL');
    }
}
